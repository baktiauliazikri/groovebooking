...
<div class="row">
    <div class="col-lg">
        <form action="{{ route('data-barberman.update', $barberman->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                name="email" value="{{ $barberman->email }}" required>
                            @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                name="phone" value="{{ $barberman->phone }}">
                            @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                                name="alamat">{{ old('alamat', $barberman->alamat) }}</textarea>
                            @error('alamat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('social') is-invalid @enderror" id="social"
                                name="social" value="{{ old('social', $barberman->social) }}">
                            @error('social')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
