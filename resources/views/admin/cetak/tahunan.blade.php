...
<body>
    ...
    <table style="font-weight: bold; width: auto;">
        <tr>
            <td>Tahun</td>
            <td>:</td>
            <td >{{ $tahun }}</td>
    ...
    <table class=" table table-bordered">
        {{-- <p style="font-weight: bold">Tahun: {{ $tahun }}</p>
        <p style="font-weight: bold">Dicetak oleh : {{ Auth::user()->name }}</p> --}}
        <thead>
